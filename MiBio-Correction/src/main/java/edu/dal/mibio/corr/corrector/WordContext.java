  ...
  implements Comparable<WordContext>
{
  ...
  {
    switch(index) {
      case 1:  return new String[]{context[0], context[1], context[2], context[3]};
      case 2:  return new String[]{context[1], context[2], context[3], context[5]};
      case 3:  return new String[]{context[2], context[3], context[5], context[6]};
      case 4:  return new String[]{context[3], context[5], context[6], context[7]};
